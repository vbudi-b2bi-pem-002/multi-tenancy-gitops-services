...
keytool -genkeypair -keystore ibm-pem.jks -storepass ${SERVER_KEYSTORE_PASSWORD} -alias pem -dname "CN=PEM, OU=CSM, O=IBM, L=Austin, ST=TX, C=US" -keypass ${SERVER_KEYSTORE_PASSWORD}
